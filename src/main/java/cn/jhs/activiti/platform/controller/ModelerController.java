...
import cn.jhs.activiti.platform.constants.Status;
import cn.jhs.activiti.platform.constants.ResponseConstant;
...
public class ModelerController implements RestServiceController<Model, String>{
    ...
    public Object newModel() throws UnsupportedEncodingException {
        ...
        ResponseConstant responseObj =  ResponseConstant.buildResult();
    ...
    public Object deploy(@PathVariable("id")String id) throws Exception {
        ...
        if (bytes == null) {
            return ResponseConstant.buildResult().status(Status.FAIL)
        ...
        return ResponseConstant.buildResult().refresh();
    }

    @Override
    public Object getOne(@PathVariable("id") String id) {
        Model model = repositoryService.createModelQuery().modelId(id).singleResult();
        return ResponseConstant.buildResult().setObjData(model);
    }
    ...
    public Object getList(@RequestParam(value = "rowSize", defaultValue = "1000", required = false) Integer rowSize, @RequestParam(value = "page", defaultValue = "1", required = false) Integer page) {
        ...
        return ResponseConstant.buildResult().setRows(
                ResponseConstant.Rows.buildRows().setCurrent(page)
